...
if ! sudo chmod +x /home/ubuntu/Documents/vm-orchestrate-datasets/client/ubuntu_daita/client.py; then
...
#!/bin/bash
/usr/bin/python3 /home/ubuntu/Documents/vm-orchestrate-datasets/client/ubuntu_daita/client.py
EOF
